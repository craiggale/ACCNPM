...
export const AppProvider = ({ children }) => {
  ...
  const [resources, setResources] = useState([
    { id: 1, name: 'Sarah Jenkins', role: 'Frontend Lead', team: 'Website', capacity: 160, leave: 0 },
    { id: 2, name: 'Mike Ross', role: '3D Artist', team: 'Asset Production', capacity: 160, leave: 0 },
    { id: 3, name: 'David Lee', role: 'Product Owner', team: 'Configurator', capacity: 160, leave: 0 },
    { id: 4, name: 'Emily Chen', role: 'Developer', team: 'Website', capacity: 160, leave: 0 },
    { id: 5, name: 'James Wilson', role: 'QA', team: 'Website', capacity: 160, leave: 0 },
    { id: 6, name: 'Anna Garcia', role: 'Designer', team: 'Configurator', capacity: 160, leave: 0 },
    { id: 7, name: 'Robert Taylor', role: 'Manager', team: 'Asset Production', capacity: 160, leave: 0 },
    { id: 8, name: 'Lisa Wong', role: 'Developer', team: 'Configurator', capacity: 160, leave: 0 },
    { id: 9, name: 'Tom Baker', role: 'QA', team: 'Configurator', capacity: 160, leave: 0 },
  ]);

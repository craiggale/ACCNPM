...
async def get_portfolio_health(db: DbSession, org_id: CurrentOrgId):
...
async def get_initiative_value(db: DbSession, org_id: CurrentOrgId):
...
async def get_schedule_variance(db: DbSession, org_id: CurrentOrgId):
